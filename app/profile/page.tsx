...
export default function ProfilePage() {
	return (
		<div className="w-11/12 mx-auto bg-gray-100 min-h-screen flex flex-col">
			{/* Header */}
			...
			<div className="bg-white p-6 flex flex-col items-center">
				<img
					src="/assets/images/file.png?height=100&width=100"
					alt="User"
					className="w-24 h-24 rounded-full mb-4"
				/>
				<h2 className="text-2xl font-bold mb-2">Abebe Teka</h2>
						...
						<Link key={item} href={`/article/${item}`} className="block">
							<div className="bg-white p-4 rounded-lg">
								...
								<p className="text-sm text-gray-500">
									Short description of the saved article...
								</p>
							</div>
						</Link>
					))}
